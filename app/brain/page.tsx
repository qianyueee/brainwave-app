...
/**
 * Sync Brain — the live EEG measurement and the 脳特性チャート analysis in one
 * page: measure at the top, analyze below. /session hosts the program/audio
 * catalogue. The 3 condition tiles here share data and computation with the
 * home tiles (same store, same computeBrainConditionMetrics), so the numbers
 * always agree.
 */
  ...
  return (
    <div className="flex flex-col gap-6 pt-6" style={{ animation: "fade-in 0.3s ease-out" }}>
      <div>
        ...
        <p className="text-sm text-text-secondary mt-1">シンク・ブレイン｜脳波同期・測定と分析</p>
      </div>
