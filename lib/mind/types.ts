 ...
 * feature. The `EegSample` shape is a three-way wire contract: the Python
 * bridge's cloud broadcast (bridge/publisher.py), the desktop app's local WS
 * `sample` message (bridge/local_server.py), and this web client — keep all
 * three in sync.
 */
